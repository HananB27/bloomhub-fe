...
import { yearOverYear } from "./analyticsModuleHelpers";

export function YearOverYearStrip() {
  const data = useMemo(() => yearOverYear(), []);
  ...
  return (
    <div className="flex flex-col gap-1.5">
      {data.map((y) => (
        ...
        >
          <div className="font-mono text-xs font-semibold text-gray-600">{y.year}</div>
